...
const FruitCard = () => {
  ...
  useEffect(() => {
    setCards([
      { image: '/src/assets/carrot.svg', name: 'Carrot', className: 'bg-orange-200' },
      { image: '/src/assets/strawberry2.svg', name: 'Strawberry', className: 'bg-red-200' },
      { image: '/src/assets/eggplant.svg', name: 'Eggplant', className: 'bg-purple-200' },
      { image: '/src/assets/cabbage.svg', name: 'Cabbage', className: 'bg-green-200' },
      { image: '/src/assets/food-grape.svg', name: 'Blue Grape', className: 'bg-green-300' },
      { image: '/src/assets/tomatoes.svg', name: 'Tomatoes', className: 'bg-red-300' },
      { image: '/src/assets/lettuce.svg', name: 'Lettuce', className: 'bg-lime-200' },
    ]);
  }, []);
  ...
  return (
    <div className="bg-white px-6 md:px-10 md:mx-3 py-12 mt-2 font-sans">
      <div className="max-w-6xl mx-auto overflow-hidden relative flex items-center">
        ...
        >
          <img src="/src/assets/left-arrow.svg" alt="left arrow" className="w-5"/>
        </button>
        <div
          ref={scrollRef}
        ...
        >
           <img src="/src/assets/right-arrow.svg" alt="right arrow" className="w-5"/>
        </button>
      </div>
    </div>
  );
