  ...
  return (
    <>
      <header className='border-b font-[sans-serif] tracking-wide relative z-50 shadow-md'>
        <section className='py-3 bg-[#0d4c57] text-white text-center px-10'>
          <p className='text-sm p-2'>Summer Sale: Save up to 40% on select items. <span className="text-red-400">Limited-time offer!</span></p>
        </section>
          <div className='container flex max-w-screen-xl px-6 py-3 md:px-12'>
            <div className='flex flex-wrap items-center lg:gap-y-2 gap-4 w-full'>
              <a href="javascript:void(0)" className="max-sm:hidden flex items-center"><img src="/src/assets/logo.png" alt="logo" className='w-6' />
                <p className="text-2xl font-extrabold text-gray-800">RICH<span className="text-green-700 font-medium">FIELD</span></p>
              </a>
              ...
              <div id="collapseMenu"
                ...
                <ul
                  ...
                  <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                    className='text-[#31da47] hover:text-[#31da47] text-[15px] block font-semibold'>Home</a></li>
                  <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                    className='text-[#333] hover:text-[#31da47] text-[15px] block font-semibold'>About</a></li>
                  <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                    className='text-[#333] hover:text-[#31da47] text-[15px] block font-semibold'>Product</a></li>
                  <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                    className='text-[#333] hover:text-[#31da47] text-[15px] block font-semibold'>Contact</a></li>
                </ul>
              </div>
              ...
              <div className="flex items-center gap-x-6 gap-y-4 ml-auto">
                ...
                <div className='flex items-center sm:space-x-8 space-x-6'>
                  ...
                  <button
                    className='max-lg:hidden px-6 py-3 text-sm text-white rounded-sm border-2 border-[#0f851f] bg-[#0f851f] hover:bg-[#0c6317]'>Sign
                    In</button>
