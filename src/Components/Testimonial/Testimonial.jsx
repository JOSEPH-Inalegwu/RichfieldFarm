  ...
  return (
    <>
      ...
      <div className="max-w-2xl">
        ...
        <p className="text-sm text-gray-500 mt-4 leading-relaxed">Our clients rave about the quality and freshness of our products. They appreciate the dedication we put into sourcing the best ingredients. With every order, we strive to exceed their expectations and provide an exceptional experience.</p>
      </div>
